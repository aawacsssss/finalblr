...
const Home: React.FC = () => {
  ...
  return (
    <>
      <section style={{ position: 'relative', marginTop: '140px' }} className="p-0">
        {sliders.length > 0 ? (
          <Swiper
        ...
        <div className="container">
          ...
          <div className="row align-items-center" style={{ marginBottom: '48px' }}>
            <div className="col-lg-6 m-a pc-p-70">
              <div className="uysal-title-2" style={{ fontSize: '2.5rem', fontWeight: 700, color: '#232617', marginBottom: '24px' }}>
                {getContentBySection('hero')?.title || 'Hayalinizdeki Yaşam Alanları'}
              </div>
              <p style={{ fontSize: '1.2rem', color: '#444', lineHeight: 1.7 }}>
                {getContentBySection('hero')?.content || 'Uysal Yapı olarak, yaşam alanlarınızı sadece bir ev değil, bir yaşam tarzı olarak tasarlıyoruz. Modern mimarinin zarif çizgileriyle, fonksiyonelliği ve estetiği bir araya getiriyor, her detayı özenle işliyoruz. Hayalinizdeki konforu ve şıklığı, gerçeğe dönüştürüyoruz.'}
              </p>
            </div>
            <div className="col-lg-6 d-flex justify-content-center">
              <div style={{ borderRadius: '24px', overflow: 'hidden', boxShadow: '0 4px 24px #0001', transition: 'transform 0.2s' }}>
                <img 
                  className="mob-mt-30" 
                  loading="lazy" 
                  alt={getContentBySection('hero')?.title || "Uysal Yapı"} 
                  src={getContentBySection('hero')?.images?.[0] || "/front/gorsel/anasayfa/1.png"} 
            ...
            <div className="col-lg-6 d-flex justify-content-center">
              <div style={{ borderRadius: '24px', overflow: 'hidden', boxShadow: '0 4px 24px #0001', transition: 'transform 0.2s' }}>
                <img 
                  className="mob-mt-30" 
                  loading="lazy" 
                  alt={getContentBySection('about_preview')?.title || "Uysal Yapı"} 
                  src={getContentBySection('about_preview')?.images?.[0] || "/front/gorsel/anasayfa/4.png"} 
                  style={{ width: '100%', height: '340px', objectFit: 'cover', objectPosition: 'center' }} 
                />
              </div>
            </div>
          ...
          <div className="row align-items-center" style={{ marginBottom: '48px' }}>
            ...
            <div className="col-lg-6 d-flex justify-content-center">
              <div style={{ borderRadius: '24px', overflow: 'hidden', boxShadow: '0 4px 24px #0001', transition: 'transform 0.2s' }}>
                <img loading="lazy" alt="Uysal Yapı" src="/front/gorsel/anasayfa/2.png" style={{ width: '100%', height: '340px', objectFit: 'cover', objectPosition: 'center' }} />
              </div>
            </div>
          </div>
          ...
          <div className="row align-items-center flex-row-reverse" style={{ marginBottom: '48px' }}>
            ...
            <div className="col-lg-6 d-flex justify-content-center">
              <div style={{ borderRadius: '24px', overflow: 'hidden', boxShadow: '0 4px 24px #0001', transition: 'transform 0.2s' }}>
                <img className="mob-mt-30" loading="lazy" alt="Uysal Yapı" src="/front/gorsel/anasayfa/3.png" style={{ width: '100%', height: '340px', objectFit: 'cover', objectPosition: 'center' }} />
              </div>
            </div>
          </div>
          ...
          <div className="row align-items-center" style={{ marginBottom: '48px' }}>
            ...
            <div className="col-lg-6 d-flex justify-content-center">
              <div style={{ borderRadius: '24px', overflow: 'hidden', boxShadow: '0 4px 24px #0001', transition: 'transform 0.2s' }}>
                <img className="mob-mt-30" loading="lazy" alt="Uysal Yapı Otopark" src="/front/gorsel/anasayfa/6.png" style={{ width: '100%', height: '340px', objectFit: 'cover', objectPosition: 'center' }} />
              </div>
            </div>
          </div>
          ...
          <div className="row align-items-center flex-row-reverse">
            ...
            <div className="col-lg-6 d-flex justify-content-center">
              <div style={{ borderRadius: '24px', overflow: 'hidden', boxShadow: '0 4px 24px #0001', transition: 'transform 0.2s' }}>
                <img className="mob-mt-30" loading="lazy" alt="Uysal Yapı Sosyal Alanlar" src="/front/gorsel/anasayfa/5.png" style={{ width: '100%', height: '340px', objectFit: 'cover', objectPosition: 'center' }} />
              </div>
            </div>
          </div>
        </div>
